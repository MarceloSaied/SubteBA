...
#AutoIt3Wrapper_Outfile=RegwxTester.exe
...
$MainGUI = GUICreate("String Regular Expression Tester", 1032, 628)
$HTabMain = GUICtrlCreateTab(5, 15, 920, 200)
$hTab1 = GUICtrlCreateTabItem("Test text")
$hInput1 = GUICtrlCreateEdit("",10,42, 908, 166)
...
$FileLoadedInput = GUICtrlCreateInput("", 90, 45, 728, 20)
...
$WebADDRInput = GUICtrlCreateInput("FULL ADDR HERE", 160, 45, 758, 20)
$hInput3 = GUICtrlCreateEdit("",10,72, 808, 136)
